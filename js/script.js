...
form.addEventListener("submit", (e) => {
  ...
  let quantify_number = Number(quantify.value)
  ...
  let result = numberGenerator(quantify_number, min_number, max_number, valueSelected)
  ...
  button1.onclick = () =>{
    ...
    spans.forEach((span) => {
      ...
      result = numberGenerator(quantify_number, min_number, max_number, valueSelected)
      insertNumbers(result, spansGroup)
  }
  button2.onclick = () => {
    location.reload()
